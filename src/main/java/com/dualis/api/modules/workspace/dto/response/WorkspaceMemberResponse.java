package com.dualis.api.modules.workspace.dto.response;
...
public class WorkspaceMemberResponse {
    ...
    @Schema(description = "Workspace role (OWNER, PARTNER, VIEWER)", example = "OWNER")
    private WorkspaceRole role;

    @Schema(description = "Joined timestamp")
    private OffsetDateTime joinedAt;

    public static WorkspaceMemberResponse fromDomain(WorkspaceMember member) {
