package com.dualis.api.modules.account.dto.response;
...
public class AccountResponse {
    ...
    public static AccountResponse fromDomain(Account account) {
        ...
        return AccountResponse.builder()
                ...
                .balance(account.getBalance() != null ? account.getBalance().amount() : null)
                .currency(account.getBalance() != null ? account.getBalance().currency() : Money.DEFAULT_CURRENCY)
