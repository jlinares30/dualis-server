...
public class AuthController {
    ...
    private final ManageAuthUseCase authService;
    ...
    @GetMapping("/me")
    @Operation(summary = "Get current user profile", description = "Retrieves profile details of the currently authenticated user from SecurityContext")
    @ApiResponses(value = {
    ...
    @PutMapping("/profile")
    @Operation(summary = "Update user profile", description = "Updates editable profile fields (first name, last name, currency) for authenticated user")
    @ApiResponses(value = {
