...
class TransactionControllerTest {
    ...
    void createTransaction_Success() throws Exception {
        ...
        when(transactionUseCase.createTransaction(any(CreateTransactionRequest.class)))
    ...
    void getTransactions_Success() throws Exception {
        ...
        when(transactionUseCase.getTransactions(
    ...
    void getTransactionById_Success() throws Exception {
        when(transactionUseCase.getTransactionById(transactionId)).thenReturn(transactionResponse);
    ...
    void getTransactionById_NotFound() throws Exception {
        when(transactionUseCase.getTransactionById(transactionId))
    ...
    void updateTransaction_Success() throws Exception {
        ...
        when(transactionUseCase.updateTransaction(eq(transactionId), any(UpdateTransactionRequest.class)))
                .thenReturn(transactionResponse);
