package com.dualis.api.modules.sync.controller;
...
class SyncControllerTest {
    ...
    @MockitoBean
    private ManageSyncUseCase syncUseCase;
    ...
    void pullDelta_Success() throws Exception {
        ...
        when(syncUseCase.pullDelta(any(SyncPullRequest.class))).thenReturn(syncResponse);
    ...
    void pushOfflineData_Success() throws Exception {
        CreateTransactionRequest txReq = CreateTransactionRequest.builder()
                ...
                .type(com.dualis.api.modules.transaction.domain.model.TransactionType.EXPENSE)
        ...
        when(syncUseCase.pushOfflineData(any(SyncPushRequest.class))).thenReturn(syncResponse);
